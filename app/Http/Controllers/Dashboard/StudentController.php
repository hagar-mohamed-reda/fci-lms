...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'code' => 'required||unique:lms_students',
            'email' => 'required|unique:lms_students',
            'username' => 'required|unique:lms_students',
            'phone' => 'required|unique:lms_students',
            'active' => 'required',
    ...
    public function update(Request $request, Student $student, User $user)
    {
        $request->validate([
            ...
            'code' => ['required', Rule::unique('lms_students')->ignore($student->id)],
            'email' => ['required', Rule::unique('lms_students')->ignore($student->id)],
            'username' => ['required', Rule::unique('lms_students')->ignore($student->id)],
            'phone' => ['required', Rule::unique('lms_students')->ignore($student->id)],
            'national_id' => 'required',
            'set_number' => 'required',
            'active' => 'required',
