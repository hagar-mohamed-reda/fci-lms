...
<div class="content-wrapper">
    <section class="content-header">
        <h1>@lang('site.student_problems')</h1>
        <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> @lang('site.dashboard')</a></li>
            <li class="active"> @lang('site.student_problems')</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                <h3 class="box-title" style="margin-bottom: 15px">@lang('site.student_problems') {{--<small>{{$subjects->total()}}</small>--}}</h3>
            </div>

            <div class="box-body">
                @if ($stdProblems->count() > 0)
                <div class="table-responsive">
                    <table class="table table-bordered" id="stdProbTable" >
                        <thead>
                            <tr>
                                <th>{{ __('site.name') }}</th>
                                <th>{{ __('site.phone') }}</th>
...
$(document).ready(function() {
     table = $('#stdProbTable').DataTable({
        "processing": true,
        "serverSide": true,
        "pageLength": 5,
        "sorting": [0, 'DESC'],
        "ajax": {
                    "url" : "{{ url('/dashboard/student-problem/data') }}",
                    "type": "get",
